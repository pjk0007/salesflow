        ...
        <div className="min-h-screen bg-[#f7f9fb] text-slate-900">
            ...
            <nav className="fixed top-0 w-full z-50 bg-white shadow-none">
                <div className="flex justify-between items-center h-16 px-4 md:px-8 max-w-[1440px] mx-auto">
                    <Link href="/" className="text-xl md:text-2xl font-black text-blue-600 tracking-tight">Sendb</Link>
                    <Link href="/" className="text-slate-500 hover:text-blue-600 transition-colors font-bold text-sm md:text-lg">홈으로 돌아가기</Link>
                </div>
            ...
            <div className="flex max-w-[1440px] mx-auto pt-16">
                ...
                {/* Main Content */}
                <main className="flex-1 px-4 md:px-16 py-8 md:py-12 bg-[#f7f9fb]">
                    <header className="mb-8 md:mb-12">
                        ...
                        <h1 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight mb-2 md:mb-4">개인정보 처리방침</h1>
                    ...
                    <div className="space-y-10 md:space-y-16 max-w-4xl">
                        ...
                        <article>
                            ...
                            <div className="bg-white p-5 md:p-8 rounded-xl shadow-sm border border-slate-200 leading-relaxed text-slate-600">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <article className="bg-white p-5 md:p-8 rounded-xl border border-slate-200">
                        ...
                        <article>
                            ...
                            <div className="bg-white p-5 md:p-8 rounded-xl shadow-sm border border-slate-200 text-slate-600 leading-relaxed">
                        ...
                        {/* CTA */}
                        <section className="bg-blue-600 text-white p-6 md:p-12 rounded-2xl md:rounded-3xl relative overflow-hidden">
                            <div className="relative z-10">
                                <h2 className="text-2xl md:text-3xl font-black mb-3 md:mb-4">도움이 필요하신가요?</h2>
                                <p className="text-blue-200 mb-6 md:mb-8 max-w-lg text-sm md:text-base">개인정보 처리방침과 관련하여 궁금한 점이 있으시거나 권리 행사가 필요하신 경우, Sendb 고객센터로 문의해 주세요.</p>
                                <div className="flex flex-wrap gap-4">
                                    <a href="mailto:support@sendb.com" className="bg-white text-blue-600 px-6 md:px-8 py-3 rounded-full font-bold text-sm md:text-base hover:bg-opacity-90 transition-all">
                                        고객센터 연결하기
                                    </a>
                                </div>
                            </div>
            ...
            <footer className="bg-white border-t border-slate-100">
                <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-8 py-8 md:py-12 w-full max-w-7xl mx-auto">
                    ...
                    <div className="flex gap-6">
                        <Link href="/terms" className="text-slate-500 hover:text-slate-800 text-xs font-medium">이용약관</Link>
                        <span className="text-slate-900 underline text-xs font-medium">개인정보처리방침</span>
                    </div>
                </div>
            </footer>
        </div>
